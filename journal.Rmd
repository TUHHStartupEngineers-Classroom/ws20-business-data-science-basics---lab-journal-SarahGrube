...
library(readr)
library(data.table)
result <- read_rds("02_data_wranging/top10.rds")
result
```
...
library(readr)
library(data.table)
result_2019 <- read_rds("02_data_wranging/top10_2019.rds")
result_2019
```
...
library(readr)
library(data.table)
result_top5 <- read_rds("02_data_wranging/top10_mainclassID.rds")
result_top5
```
